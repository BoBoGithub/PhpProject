<?php /* Smarty version Smarty-3.1.7, created on 2018-03-07 16:19:17
         compiled from "/var/www/projects/common/conf/../../resources/templates/admin/setup/MenuAdd.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18147438775a9f5c3a0bbed2-15866452%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c217b32d3b800eb78747b7e51a1e4196c004f85' => 
    array (
      0 => '/var/www/projects/common/conf/../../resources/templates/admin/setup/MenuAdd.tpl',
      1 => 1520404848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18147438775a9f5c3a0bbed2-15866452',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5a9f5c3a0efd9',
  'variables' => 
  array (
    'menuData' => 0,
    'menuId' => 0,
...
<?php if ($_valid && !is_callable('content_5a9f5c3a0efd9')) {function content_5a9f5c3a0efd9($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("../common/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
					...
					<div class="col-sm-9">
						<div class="dropdown">  
								<button class="btn btn-default" data-toggle="dropdown" id="dropdownBtn">  
									<span id="menText"><?php if (empty($_smarty_tpl->tpl_vars['menuData']->value['name'])){?>作为一级菜单<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['menuData']->value['name'];?>
<?php }?></span>  
									<span class="caret"></span>  
								</button>  
								<input type="hidden" value="<?php if (empty($_smarty_tpl->tpl_vars['menuData']->value['id'])){?>0<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['menuData']->value['id'];?>
<?php }?>" id="parentId" />
