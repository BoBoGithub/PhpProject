...
<link rel="stylesheet"	href="{{$STATIC_HOST}}/css/admin/admin_files/min.css">
<link rel="stylesheet"	href="{{$STATIC_HOST}}/css/admin/admin_files/login.css">
<link rel="stylesheet" href="{{$STATIC_HOST}}/css/admin/admin_files/css.css">
<script src="{{$STATIC_HOST}}/js/admin/jquery-1.8.3.js"></script> 
<script src="{{$STATIC_HOST}}/js/admin/layer-v1.9.2/layer/layer.js"></script>
</head>
<body onload="javascript:topLoad()" style="background-image: url('{{$STATIC_HOST}}/css/admin/admin_files/2zrdI1g.jpg');margin-top:0px;background-repeat:no-repeat;background-size: 100% auto;" onkeydown="enterLogin();">
		...
		<form id="loginform" name="loginform" class="form-vertical" style="background-color: rgba(0, 0, 0, 0.5) !important; background: #000; filter: alpha(opacity = 50); *background: #000; *filter: alpha(opacity = 50); /*黑色透明背景结束*/ color: #FFF; bottom: 0px; right: 0px; border: 1px solid #000;" method="post">
			<div class="control-group normal_text">
				<table style="width: 100%">
					<tr>
						<td align="left">
							<img src="{{$STATIC_HOST}}/css/admin/admin_files/logo_left.png" alt="Logo">
						</td>
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly" style="background: #28b779">
							<img src="{{$STATIC_HOST}}/css/admin/admin_files/account_1.png" alt="请输入账号..">
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly">
							<img src="{{$STATIC_HOST}}/css/admin/admin_files/lock_1.png" alt="请输入密码..">
